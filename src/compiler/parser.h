...
namespace yalx {
    ...
    namespace cpl {
        ...
        private:
            ...
            Expression *
            ParseCommaSplittedExpressions(base::ArenaVector<Expression *> *list, Expression *receiver[2], bool *ok);

            Expression *ParseCommaSplittedExpressions(base::ArenaVector<Expression *> *receiver, bool *ok);

            Expression *
            ParseRemainLambdaLiteral(FunctionPrototype *prototype, const SourcePosition &location, bool *ok);
            ...
            Expression *
            NewBinaryExpression(const Operator &op, Expression *lhs, Expression *rhs, const SourcePosition &location) {

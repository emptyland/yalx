...
TEST_F(SourcePositionTest, SourcePositionTable) {
    ...
    auto file_id = source_position_table_.FindOrInsertFileName("main.yalx");
    EXPECT_EQ(0, file_id);
    EXPECT_EQ(file_id, source_position_table_.FindOrInsertFileName("main.yalx"));
    
    //file_name = base::ArenaString::New(&arena_, "foo.yalx");
    auto file_id2 = source_position_table_.FindOrInsertFileName("foo.yalx");
...
TEST_F(SourcePositionTest, SourcePositionTableScope) {
    //auto file_name = base::ArenaString::New(&arena_, "main.yalx");
    SourcePositionTable::Scope scope("main.yalx", {1,2}, &source_position_table_);

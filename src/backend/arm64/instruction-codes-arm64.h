...
#ifndef YAX_BACKEND_ARM64_INSTRUCTION_CODES_ARM64_H_
#define YAX_BACKEND_ARM64_INSTRUCTION_CODES_ARM64_H_
...
#define ARM64_ADDRESSING_MODE_LIST(V)                            \
    V(MRI)              /* [%r0 + K] */                           \
    V(MRR)              /* [%r0 + %r1] */                         \
...
#endif  // YAX_BACKEND_ARM64_INSTRUCTION_CODES_ARM64_H_
